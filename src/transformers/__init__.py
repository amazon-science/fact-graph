...
_import_structure = {
    ...
    "models.electra_adapter": ["ELECTRA_PRETRAINED_CONFIG_ARCHIVE_MAP", "ElectraConfig", "ElectraTokenizer"],
...
if is_torch_available():
    ...
    _import_structure["models.electra_adapter"].extend(
        [
            "ElectraAdapterModel",
            "ElectraAdapterForMaskedLM",
        ]
    )
...
if TYPE_CHECKING:
    ...
    if is_torch_available():
        ...
        from .models.electra_adapter import (
            ElectraAdapterModel,
            ElectraAdapterForMaskedLM,
        )
